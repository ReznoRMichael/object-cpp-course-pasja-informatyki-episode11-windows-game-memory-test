...
int ile=0;  // runda / ile sygnalow
int licznik=0;  // ile klikniec w rundzie

void sekwencja()
{
    Application->ProcessMessages(); Sleep(1000);    // dla napisu Great!
    ...
    Form1->Label1->Caption = "Memorize the sequence";
    Application->ProcessMessages(); Sleep(1000);
    ...
    for(int i=0; i<ile; i++)
    {
        ...
        Application->ProcessMessages(); Sleep(1200);    // tyle trwaja dzwieki
        ...
        Application->ProcessMessages(); Sleep(100); // na wypadek duplikatu zarowki
    ...
    Form1->Label1->Caption = "Repeat the sequence";
...
void __fastcall TForm1::z1Click(TObject *Sender)
{
    if(gra_rozpoczeta == true)
    {
        ...
        {
            ile--;
            Label1->Caption = "Wrong! Your score: "+IntToStr(ile);
